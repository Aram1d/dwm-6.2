...
setup(void)
{
	...
	for(int i = 0; i < NUMCOLORS; i++){
	  scheme[i].border = drw_clr_create(drw, colors[i][0], borderalpha);
	  scheme[i].fg = drw_clr_create(drw, colors[i][1], OPAQUE);
	  scheme[i].bg = drw_clr_create(drw, colors[i][2], baralpha);
	}
